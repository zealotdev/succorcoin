...
export default function Charity() {
  ...
  return (
    <div className="bg-gradient-to-br from-purple-400 to-pink-400 py-10 flex justify-center pb-14">
      <div className="flex flex-col items-center text-center space-y-8">
        ...
        <div>
          <form className="flex flex-col space-y-4 items-start">
            ...
            <button className="w-full border border-gray-50 py-3 px-6 rounded-lg text-purple-400 tracking-wider font-semibold uppercase bg-white  hover:bg-gray-50 duration-200">
              Submit
            </button>
          </form>
        </div>
