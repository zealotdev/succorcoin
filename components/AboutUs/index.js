...
export default function AboutUs() {
  ...
  useEffect(() => {
    ...
    tl.fromTo(aboutRef.current, { opacity: 0.1, y: 120 }, { opacity: 1, y: 0 });
  }, []);

  return (
    <div className="about-us-bg bg-no-repeat bg-contain flex flex-col justify-center">
      <div className="flex justify-evenly" ref={aboutRef}>
        <div>
          <Image
            src="/logo.png"
            height={400}
